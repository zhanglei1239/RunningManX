...
// general appearance
static const CGFloat CSToastVerticalPadding     =60.0;
...
static const CGFloat CSToastMoveDuration        =0.1;
static const CGFloat CSToastPosition            =15.0;
static const CGFloat CSToastDelay               =0.0;
...
- (UILabel *)makeViewOfMessage:(NSString *)msg withColorType:(int)colorType
{
    ...
    UILabel * messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,0, ScreenWidth,CSToastHeight)];
    ...
    messageLabel.center =CGPointMake(ScreenWidth/2, ScreenHeight/2);
